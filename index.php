  ...
  <section class="topContent">
    <div class="mainHeading">
      ...
      <div style="margin-top: 12px;">
        <span class="sub-content">Bank perform a myriad of functions, including deposits and withdrawals,
         currency exchange, forex trading, and wealth management.
          Also, they act as a link between depositors and borrowers,
           and they use the funds deposited by their customers to provide credit facilities
    ...
    <div class="topContentImg">
      <img src="images/banking_homepage.png" alt="Banking">
    </div>
  </section>
  <!-- End Home -->
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 mx-auto mt-4">
          ...
          <div class="mt-2">
            <span class="sub-content">"banking business" means the business of receiving money on current or
             deposit account, paying and collecting cheques drawn by or paid in by customers.
            It is a Basic Banking System for making transactions between users.
      ...
      <div class="row">
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text"> Transections between multiple accounts</p>
